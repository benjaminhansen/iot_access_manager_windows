...
#define PHP_EXTENSION_DIR       "/usr/local/Cellar/php71/7.1.5_17/lib/php/extensions/no-debug-non-zts-20160303"
#define PHP_PREFIX              "/usr/local/Cellar/php71/7.1.5_17"
#define PHP_BINDIR              "/usr/local/Cellar/php71/7.1.5_17/bin"
#define PHP_SBINDIR             "/usr/local/Cellar/php71/7.1.5_17/sbin"
#define PHP_MANDIR              "/usr/local/Cellar/php71/7.1.5_17/share/man"
#define PHP_LIBDIR              "/usr/local/Cellar/php71/7.1.5_17/lib/php"
#define PHP_DATADIR             "/usr/local/Cellar/php71/7.1.5_17/share/php"
#define PHP_SYSCONFDIR          "/usr/local/etc/php/7.1"
#define PHP_LOCALSTATEDIR       "/usr/local/var"
#define PHP_CONFIG_FILE_PATH    "/usr/local/etc/php/7.1"
#define PHP_CONFIG_FILE_SCAN_DIR    "/usr/local/etc/php/7.1/conf.d"
